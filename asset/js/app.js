...
// 			<h4>Temperature: ${formatTemp}℃<</h4>
// 			<h4>Wind:${weatherItem.wind.speed}  M/S</h4>
// 			<h4>Humidity: ${weatherItem.main.humidity}% </h4>
// 		</div>
// 		<div class="icon">
// 			<img src = "https://openweathermap.org/img/wn/${weatherItem[0].icon}@4x.png" />
...
// 			fiveDatsForecast.forEach((weatherItem, index) => {
// 				if (index === 0) {
...
function getuserCordinates() {
	navigator.geolocation.getCurrentPosition(
		(position) => {
			...
			const REVERSE_GEOCODING_URL_ = "";
		},
		(error) => {
			if (error.code == error.PERMISSION_DENIED) {
				alert("Please access your location");
			}
		}
	);
}
